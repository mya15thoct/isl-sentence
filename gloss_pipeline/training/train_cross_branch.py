"""
Train Cross-Branch Attention classifier on ISL-Frames-Data keypoints.

Usage:
  python gloss_pipeline/training/train_cross_branch.py \
      --kp_dir /mnt/ngan/ISL-Sequences/frame_keypoints \
      --ckpt_dir /mnt/ngan/ISL-Sequences/checkpoints/cross_branch_attn
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_dir',         default=str(ISL_SEQ_DIR / 'checkpoints' / 'cross_branch_attn'))
